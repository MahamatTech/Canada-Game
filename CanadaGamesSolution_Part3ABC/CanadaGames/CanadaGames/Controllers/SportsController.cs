...
namespace CanadaGames.Controllers
{
    ...
    public class SportsController : Controller
    {
        ...
        public SportsController(CanadaGamesContext context, IMyEmailSender emailSender)
        {
            _context = context;
        ...
        //        return NotFound();
        //    }
        //    Sport t = await _context.Sports.FindAsync(id);

        //    ViewData["id"] = id;
        //    ViewData["Code"] = t.Code;
        ...
        //        {
        //            //Send a Notice.
        //            List<EmailAddress> folks = (from p in _context.Athletes
        //                                        where p.CoachID == id
