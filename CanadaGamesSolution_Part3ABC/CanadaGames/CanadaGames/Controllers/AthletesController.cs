...
namespace CanadaGames.Controllers
{
    ...
    public class AthletesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string AthleteSearch, string MediaInfoSearch, string sortDirectionCheck, string sortFieldID,
        ...
        [Authorize(Roles = "Admin,Supervisor,Security,Staff")]
        ...
        public IActionResult PlacementReporSummary()
        {
                ...
                .Select(grp => new PlacementReporSummary
                {
                ...
                LastName = grp.Key.LastName,
                 HighestPlacement = grp.Max(a => a.Place),
                    ...
                    Averageplacement = (decimal)grp.Average(a => a.Place),
                TotalEvents = grp.Count()
});
        ...
        public IActionResult DownloadAppointments()
        {
            ...
            var placements = from a in _context.Athletes
            ...
            .Include(a => a.Contingent)
                             ...
                             select new
                             {
                                 ...
                                 AvgPlace = a.Placements.Average(a => a.Place),
                                 HighPlace = a.Placements.Max(a => a.Place),
                                 LowPlace = a.Placements.Min(a => a.Place),
                                 Number_of_Events = a.Placements.Count(),
            ...
            if (numRows > 0) //We have data
            {
                ...
                using (ExcelPackage excel = new ExcelPackage())
                {
                    ...
                    var workSheet = excel.Workbook.Worksheets.Add("Placement");

                    //Note: Cells[row, column]
                    workSheet.Cells[3, 1].LoadFromCollection(placements, true);
                   ...
                   // workSheet.Column(4).Style.Numberformat.Format = "###,##0.00";
                    ...
                    {
                        totalfees.Formula = "Count(" + workSheet.Cells[4, 4].Address + ":" + workSheet.Cells[numRows + 3, 4].Address + ")";
                    ...
                    if (syncIOFeature != null)
                    {
                        ...
                        using (var memoryStream = new MemoryStream())
                        {
                            ...
                            Response.Headers["content-disposition"] = "attachment;  filename=Placement.xlsx";
                    ...
                    else
                    {
                        try
                        {
                            ...
                            string filename = "Placement.xlsx";
